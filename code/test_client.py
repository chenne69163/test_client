...
def main():
    ...
    class MySQLClient(Thread):
        ...
        def run(self):
            ...
            Label1 = tkinter.Label(panel1, text='host:',width=10)
            ...
            Label2 = tkinter.Label(panel2, text='user:',width=10)
            ...
            Label3 = tkinter.Label(panel3, text='password:',width=10)
            ...
            Label4 = tkinter.Label(panel4, text='database:',width=10)
            ...
            Label5 = tkinter.Label(panel5, text='charset:',width=10)
            ...
            Label6 = tkinter.Label(panel6, text='port:',width=10)
